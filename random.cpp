...
void printMenu(int taskListCount, string taskList[], string doneTasks[]);
...
int main()
{
    ...
    int feelings = 0; 
    cin >> feelings;
    printMenu(taskListCount, taskList, doneTasks);
    displayMenu();
...
void displayMenu()
{
    ...
    cout << "4. View Complete Tasks" << endl;
    cout << "5. Delete A Task" << endl;
    cout << "6. Display an inspirational quote" << endl;
    cout << "7. View Your Buddy (Based On Tasks Done)" << endl;
    cout << "8. View Resources" << endl; 
    cout << "9. End Day" << endl;
    cout << "========================================" << endl << endl;
}
...
void character(int tasksDone, string name)
{
    switch(tasksDone)
    {
        ...
        case 3: 
        case 4:
            cout << name << " is looking quite happy! Look's like they're almost done growing!\n\n";
            cout << "    _O_     \n";
            cout << "   |   |   \n";
            cout << "    \\ /      \n";
            cout << "    / \\    \n\n";
...
void optionCheck(string taskList[], int taskListCount, string doneTasks[], int doneTasksCount, string name)
{
    ...
    switch(choice)
    {
        ...
        case 4: //DISPLAY COMPLETE TASKS
            cout << "Completed Tasks List:\n";
            displayList(doneTasks, doneTasksCount);
            cout << "Hit enter to continue";
            cin.ignore();
            cin.get(temp);
            displayMenu();
        ...
        case 6: //DISPLAY AN INSPIRATIONAL QUOTE
            generateQuote();
            cout << "Hit enter to continue";
            cin.ignore();
            cin.get(temp);
